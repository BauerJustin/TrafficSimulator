...
## Run Instructions
Download and extract the [TrafficSimulator.zip](https://github.com/justinbauer-1/TrafficSimulator/blob/master/TrafficSimulator.zip) file and run `TrafficSimulator.jar` to see the program in action. On the other hand, you can download all the files and run the AnimationFrame.java file to start the program.
